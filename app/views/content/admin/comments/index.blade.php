...
<?php 
    ...
    ?>
    {{ Form::open(['role' => 'form', 'url' => 'admin/comments', 'method' =>'get', 'class' => 'pull-right top20 table-search-form']) }}
                ...
                @foreach ($comments as $comment)
                    <tr>
                        ...
                        <td>
                            ...
                            {{ Form::open(['url' => 'admin/comments/destroy/' . $comment->id, 'method' => 'DELETE']) }}
                                {{ Form::submit('Delete', ['class' => 'btn btn-danger btn-xs left10','onclick'=>'return confirm(\'Delete comment?\')?true:false;'])}}
                            {{ Form::close() }}
                        </td>
                    </tr>
                @endforeach
