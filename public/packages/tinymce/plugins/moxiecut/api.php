...
$uploaddir = "/bestfishing/components/wysiwyg/tinymce/plugins/moxiecut/uploads";
...
function sendparamsfile($path,$size,$modify,$file=false){
    ...
    $data = array(      //��� ���� ����� ��������� ���������� ����� thumbnails
        ...
        "canPreview"=>false,
        "exists"=>true,
        "meta"=>array("url"=>$url.'/bestfishing/components/wysiwyg/tinymce/plugins/moxiecut/uploads/'.$path),
        "info"=>array(""=>"")
    );
    return $data;
}
